        ...
        <Fragment> 
           ...
           <div className="skills-body">
                ...
                <p>
                   ...
                   Herramientas que he usado en areas de trabajo son  Visual Studio Code , Git, Visual Studio , Jira, Github, Firebase ,Heroku , Redmine , Zoom , Gitlab , Teams, FileZilla, Spira, Unity , Microsoft Office.
                </p>
                     <div className="certi">
                         Certificados
